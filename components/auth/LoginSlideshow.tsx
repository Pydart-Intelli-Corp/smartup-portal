...
const headlines = [
  { top: 'Learn Without', bottom: 'Boundaries', sub: 'Live classes from the best teachers, anywhere in the world' },
  { top: 'Your Future', bottom: 'Starts Here', sub: 'Smart classrooms powered by real-time collaboration' },
  { top: 'Excellence in', bottom: 'Every Lesson', sub: 'Interactive whiteboards, live video & instant feedback' },
  { top: 'Empowering', bottom: 'Young Minds', sub: 'Trusted by students and parents across the GCC' },
];
