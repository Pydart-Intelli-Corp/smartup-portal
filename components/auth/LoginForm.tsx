  ...
  function backBtn(onClick: () => void) {
    return (
      <button
        ...
        className="flex items-center gap-1.5 text-emerald-200/60 hover:text-emerald-200 text-sm transition-colors mb-6"
      >
    ...
    <div className="flex flex-col h-full justify-center max-w-sm mx-auto">
      ...
      {forgotStep === 'login' && (
        <>
          <div className="mb-10">
            ...
            <p className="text-emerald-200/70 text-[15px]">Sign in to continue to your dashboard</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex justify-end -mt-2">
              <button
                ...
                className="text-emerald-300/70 hover:text-emerald-200 text-[13px] transition-colors"
              >
                Forgot password?
              </button>
            </div>
        ...
        <>
          ...
          <div className="mb-8 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-emerald-200/60 text-[13px]">We&apos;ll send a verification code to your email</p>
            </div>
          </div>
      ...
      {forgotStep === 'forgot-otp' && (
        <>
          ...
          <div className="mb-8 flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-semibold tracking-tight text-white">Enter code</h1>
              <p className="text-emerald-200/60 text-[13px]">Sent to <span className="text-emerald-300">{forgotEmail}</span></p>
            </div>
          </div>
          ...
          <form onSubmit={handleVerifyOtp} className="space-y-6">
            ...
            <p className="text-[13px] text-emerald-200/40 -mt-2">
              Didn&apos;t receive it?{' '}
              <button
                type="button"
                onClick={handleForgotSubmitEmail as unknown as () => void}
                className="text-emerald-300/70 hover:text-emerald-200 underline underline-offset-2"
                disabled={loading}
              >
                Resend code
              </button>
      ...
      {forgotStep === 'forgot-newpass' && (
        <>
          <div className="mb-8 flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-semibold tracking-tight text-white">New password</h1>
              <p className="text-emerald-200/60 text-[13px]">Choose a strong password for your account</p>
            </div>
          </div>
      ...
      {forgotStep === 'forgot-done' && (
        <div className="text-center py-8">
          <div className="w-16 h-16 rounded-2xl bg-emerald-400/15 flex items-center justify-center mx-auto mb-6">
            <ShieldCheck className="size-8 text-emerald-300" />
          </div>
          <h1 className="text-2xl font-semibold tracking-tight text-white mb-2">Password updated</h1>
          <p className="text-emerald-200/60 text-[14px] mb-8">You can now sign in with your new password.</p>
          <button
